//
//  SXColorTrackingViewController.m
//  GPUImage
//
...
@interface SXColorTrackingViewController () {
    CALayer *trackingDot;
...
@implementation SXColorTrackingViewController
...
- (void)configureVideoFiltering {
    ...
    filteredVideoView = [[GPUImageView alloc] initWithFrame:mainScreenFrame];
    ...
    __unsafe_unretained SXColorTrackingViewController *weakSelf = self;
...
- (void)configureToolbar {
    ...
    UIToolbar *lowerToolbar = [[UIToolbar alloc] initWithFrame:CGRectMake(0.0f, self.view.frame.size.height - 84.0f, self.view.frame.size.width, 44.0f)];
...
{
    ColorTrackingDisplayMode newDisplayMode = (ColorTrackingDisplayMode)[sender selectedSegmentIndex];
...
#pragma mark - (BOOL)shouldAutorotateToInterfaceOrientation:(UIInterfaceOrientation)interfaceOrientation
